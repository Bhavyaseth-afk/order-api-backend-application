"""
Shared configuration for OrderAPI microservices.
"""
import os
...
# Cache configuration for health checks - using simple cache instead of Redis
CACHES = {
    'default': {
...
MAX_ORDER_PRICE = 999999.99

# Service ports
SERVICE_PORTS = {
    'order_management': 8000,
    'trade_service': 8001,
    'websocket_service': 8002,
}

# Redis channels for inter-service communication
REDIS_CHANNELS = {
